...
if quantity_files > 0:
    ...
    # suponiendo que el archivo esta en el mismo directorio del script
        ...
        query_cont = "update bases set estado=(%s) ,registros=(%s),errores=(%s) where id=(%s)"
        cursor.execute(query_cont, (5,total,error,base_id))
    ...
    query_cont = "update crones set estado=(%s),consulta=(%s) where id=(%s)"
    cursor.execute(query_cont, (0,0,cron[0]))
